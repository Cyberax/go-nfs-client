...
var _XdrNames_Nfsstat4 = map[int32]string{
	...
	int32(NFS4ERR_BADZDR): "NFS4ERR_BADZDR",
...
var _XdrValues_Nfsstat4 = map[string]int32{
	...
	"NFS4ERR_BADZDR": int32(NFS4ERR_BADZDR),
...
func (u *Locker4) Open_owner() *Open_to_lock_owner4 {
	...
	case true:
		if v, ok := u._u.(*Open_to_lock_owner4); ok {
			return v
		} else {
...
func (u *Locker4) Lock_owner() *Exist_lock_owner4 {
	switch u.New_lock_owner {
	case false:
		if v, ok := u._u.(*Exist_lock_owner4); ok {
			return v
		} else {
...
func (u *Nfs_space_limit4) Mod_blocks() *Nfs_modified_limit4 {
	...
	case NFS_LIMIT_BLOCKS:
		if v, ok := u._u.(*Nfs_modified_limit4); ok {
			return v
		} else {
...
func (u *Open_claim4) Delegate_type() *Open_delegation_type4 {
	switch u.Claim {
	case CLAIM_PREVIOUS:
		if v, ok := u._u.(*Open_delegation_type4); ok {
			return v
		} else {
...
func (u *Open_claim4) Delegate_cur_info() *Open_claim_delegate_cur4 {
	...
	case CLAIM_DELEGATE_CUR:
		if v, ok := u._u.(*Open_claim_delegate_cur4); ok {
			return v
		} else {
...
func (u *Open_delegation4) Read() *Open_read_delegation4 {
	...
	case OPEN_DELEGATE_READ:
		if v, ok := u._u.(*Open_read_delegation4); ok {
			return v
		} else {
...
func (u *Open_delegation4) Write() *Open_write_delegation4 {
	...
	case OPEN_DELEGATE_WRITE:
		if v, ok := u._u.(*Open_write_delegation4); ok {
			return v
		} else {
...
func (u *OPEN_CONFIRM4res) Resok4() *OPEN_CONFIRM4resok {
	switch u.Status {
	case NFS4_OK:
		if v, ok := u._u.(*OPEN_CONFIRM4resok); ok {
			return v
		} else {
...
func (u *OPEN_DOWNGRADE4res) Resok4() *OPEN_DOWNGRADE4resok {
	switch u.Status {
	case NFS4_OK:
		if v, ok := u._u.(*OPEN_DOWNGRADE4resok); ok {
			return v
		} else {
...
func (u *READLINK4res) Resok4() *READLINK4resok {
	switch u.Status {
	case NFS4_OK:
		if v, ok := u._u.(*READLINK4resok); ok {
			return v
		} else {
...
func (u *Secinfo4) Flavor_info() *Rpcsec_gss_info {
	switch u.Flavor {
	case RPCSEC_GSS:
		if v, ok := u._u.(*Rpcsec_gss_info); ok {
			return v
		} else {
...
func (u *SETCLIENTID4res) Resok4() *SETCLIENTID4resok {
	switch u.Status {
	case NFS4_OK:
		if v, ok := u._u.(*SETCLIENTID4resok); ok {
			return v
		} else {
...
func (u *Callback_sec_parms4) Cbsp_sys_cred() *Authsys_parms {
	switch u.Cb_secflavor {
	case AUTH_SYS:
		if v, ok := u._u.(*Authsys_parms); ok {
			return v
		} else {
...
func (v *Callback_sec_parms4) XdrInitialize() {
	...
	case AUTH_NONE, AUTH_SYS:
	default:
		if v.Cb_secflavor == zero { v.Cb_secflavor = AUTH_NONE }
	}
}
...
func (u *CREATE_SESSION4res) Csr_resok4() *CREATE_SESSION4resok {
	switch u.Csr_status {
	case NFS4_OK:
		if v, ok := u._u.(*CREATE_SESSION4resok); ok {
			return v
		} else {
...
func (u *GET_DIR_DELEGATION4res_non_fatal) Gddrnf_resok4() *GET_DIR_DELEGATION4resok {
	...
	case GDD4_OK:
		if v, ok := u._u.(*GET_DIR_DELEGATION4resok); ok {
			return v
		} else {
...
func (u *GET_DIR_DELEGATION4res) Gddr_res_non_fatal4() *GET_DIR_DELEGATION4res_non_fatal {
	...
	case NFS4_OK:
		if v, ok := u._u.(*GET_DIR_DELEGATION4res_non_fatal); ok {
			return v
		} else {
...
func (u *GETDEVICEINFO4res) Gdir_resok4() *GETDEVICEINFO4resok {
	...
	case NFS4_OK:
		if v, ok := u._u.(*GETDEVICEINFO4resok); ok {
			return v
		} else {
...
func (u *GETDEVICELIST4res) Gdlr_resok4() *GETDEVICELIST4resok {
	...
	case NFS4_OK:
		if v, ok := u._u.(*GETDEVICELIST4resok); ok {
			return v
		} else {
...
func (u *LAYOUTCOMMIT4res) Locr_resok4() *LAYOUTCOMMIT4resok {
	...
	case NFS4_OK:
		if v, ok := u._u.(*LAYOUTCOMMIT4resok); ok {
			return v
		} else {
...
func (u *LAYOUTGET4res) Logr_resok4() *LAYOUTGET4resok {
	...
	case NFS4_OK:
		if v, ok := u._u.(*LAYOUTGET4resok); ok {
			return v
		} else {
...
func (u *Layoutreturn4) Lr_layout() *Layoutreturn_file4 {
	...
	case LAYOUTRETURN4_FILE:
		if v, ok := u._u.(*Layoutreturn_file4); ok {
			return v
		} else {
...
func (u *LAYOUTRETURN4res) Lorr_stateid() *Layoutreturn_stateid {
	...
	case NFS4_OK:
		if v, ok := u._u.(*Layoutreturn_stateid); ok {
			return v
		} else {
...
func (u *SEQUENCE4res) Sr_resok4() *SEQUENCE4resok {
	switch u.Sr_status {
	case NFS4_OK:
		if v, ok := u._u.(*SEQUENCE4resok); ok {
			return v
		} else {
...
func (u *TEST_STATEID4res) Tsr_resok4() *TEST_STATEID4resok {
	switch u.Tsr_status {
	case NFS4_OK:
		if v, ok := u._u.(*TEST_STATEID4resok); ok {
			return v
		} else {
...
func (u *WANT_DELEGATION4res) Wdr_resok4() *Open_delegation4 {
	switch u.Wdr_status {
	case NFS4_OK:
		if v, ok := u._u.(*Open_delegation4); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opdelegpurge() *DELEGPURGE4args {
	switch u.Argop {
	case OP_DELEGPURGE:
		if v, ok := u._u.(*DELEGPURGE4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opdelegreturn() *DELEGRETURN4args {
	switch u.Argop {
	case OP_DELEGRETURN:
		if v, ok := u._u.(*DELEGRETURN4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opopen_confirm() *OPEN_CONFIRM4args {
	...
	case OP_OPEN_CONFIRM:
		if v, ok := u._u.(*OPEN_CONFIRM4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opopen_downgrade() *OPEN_DOWNGRADE4args {
	...
	case OP_OPEN_DOWNGRADE:
		if v, ok := u._u.(*OPEN_DOWNGRADE4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opsetclientid() *SETCLIENTID4args {
	switch u.Argop {
	case OP_SETCLIENTID:
		if v, ok := u._u.(*SETCLIENTID4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opsetclientid_confirm() *SETCLIENTID_CONFIRM4args {
	...
	case OP_SETCLIENTID_CONFIRM:
		if v, ok := u._u.(*SETCLIENTID_CONFIRM4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Oprelease_lockowner() *RELEASE_LOCKOWNER4args {
	...
	case OP_RELEASE_LOCKOWNER:
		if v, ok := u._u.(*RELEASE_LOCKOWNER4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opcreatesession() *CREATE_SESSION4args {
	...
	case OP_CREATE_SESSION:
		if v, ok := u._u.(*CREATE_SESSION4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opdestroysession() *DESTROY_SESSION4args {
	...
	case OP_DESTROY_SESSION:
		if v, ok := u._u.(*DESTROY_SESSION4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opfreestateid() *FREE_STATEID4args {
	...
	case OP_FREE_STATEID:
		if v, ok := u._u.(*FREE_STATEID4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opgetdirdelegation() *GET_DIR_DELEGATION4args {
	...
	case OP_GET_DIR_DELEGATION:
		if v, ok := u._u.(*GET_DIR_DELEGATION4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opgetdeviceinfo() *GETDEVICEINFO4args {
	...
	case OP_GETDEVICEINFO:
		if v, ok := u._u.(*GETDEVICEINFO4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opgetdevicelist() *GETDEVICELIST4args {
	...
	case OP_GETDEVICELIST:
		if v, ok := u._u.(*GETDEVICELIST4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Oplayoutcommit() *LAYOUTCOMMIT4args {
	...
	case OP_LAYOUTCOMMIT:
		if v, ok := u._u.(*LAYOUTCOMMIT4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Oplayoutget() *LAYOUTGET4args {
	switch u.Argop {
	case OP_LAYOUTGET:
		if v, ok := u._u.(*LAYOUTGET4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Oplayoutreturn() *LAYOUTRETURN4args {
	...
	case OP_LAYOUTRETURN:
		if v, ok := u._u.(*LAYOUTRETURN4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opsecinfononame() *SECINFO_NO_NAME4args {
	...
	case OP_SECINFO_NO_NAME:
		if v, ok := u._u.(*SECINFO_NO_NAME4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opteststateid() *TEST_STATEID4args {
	...
	case OP_TEST_STATEID:
		if v, ok := u._u.(*TEST_STATEID4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opwantdelegation() *WANT_DELEGATION4args {
	...
	case OP_WANT_DELEGATION:
		if v, ok := u._u.(*WANT_DELEGATION4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opdestroyclientid() *DESTROY_CLIENTID4args {
	...
	case OP_DESTROY_CLIENTID:
		if v, ok := u._u.(*DESTROY_CLIENTID4args); ok {
			return v
		} else {
...
func (u *Nfs_argop4) Opreclaimcomplete() *RECLAIM_COMPLETE4args {
	...
	case OP_RECLAIM_COMPLETE:
		if v, ok := u._u.(*RECLAIM_COMPLETE4args); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opdelegpurge() *DELEGPURGE4res {
	switch u.Resop {
	case OP_DELEGPURGE:
		if v, ok := u._u.(*DELEGPURGE4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opdelegreturn() *DELEGRETURN4res {
	switch u.Resop {
	case OP_DELEGRETURN:
		if v, ok := u._u.(*DELEGRETURN4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opopen_confirm() *OPEN_CONFIRM4res {
	switch u.Resop {
	case OP_OPEN_CONFIRM:
		if v, ok := u._u.(*OPEN_CONFIRM4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opopen_downgrade() *OPEN_DOWNGRADE4res {
	switch u.Resop {
	case OP_OPEN_DOWNGRADE:
		if v, ok := u._u.(*OPEN_DOWNGRADE4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opsetclientid() *SETCLIENTID4res {
	switch u.Resop {
	case OP_SETCLIENTID:
		if v, ok := u._u.(*SETCLIENTID4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opsetclientid_confirm() *SETCLIENTID_CONFIRM4res {
	switch u.Resop {
	case OP_SETCLIENTID_CONFIRM:
		if v, ok := u._u.(*SETCLIENTID_CONFIRM4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Oprelease_lockowner() *RELEASE_LOCKOWNER4res {
	switch u.Resop {
	case OP_RELEASE_LOCKOWNER:
		if v, ok := u._u.(*RELEASE_LOCKOWNER4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opcreatesession() *CREATE_SESSION4res {
	switch u.Resop {
	case OP_CREATE_SESSION:
		if v, ok := u._u.(*CREATE_SESSION4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opdestroysession() *DESTROY_SESSION4res {
	switch u.Resop {
	case OP_DESTROY_SESSION:
		if v, ok := u._u.(*DESTROY_SESSION4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opfreestateid() *FREE_STATEID4res {
	switch u.Resop {
	case OP_FREE_STATEID:
		if v, ok := u._u.(*FREE_STATEID4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opgetdirdelegation() *GET_DIR_DELEGATION4res {
	switch u.Resop {
	case OP_GET_DIR_DELEGATION:
		if v, ok := u._u.(*GET_DIR_DELEGATION4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opgetdeviceinfo() *GETDEVICEINFO4res {
	switch u.Resop {
	case OP_GETDEVICEINFO:
		if v, ok := u._u.(*GETDEVICEINFO4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opgetdevicelist() *GETDEVICELIST4res {
	switch u.Resop {
	case OP_GETDEVICELIST:
		if v, ok := u._u.(*GETDEVICELIST4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Oplayoutcommit() *LAYOUTCOMMIT4res {
	switch u.Resop {
	case OP_LAYOUTCOMMIT:
		if v, ok := u._u.(*LAYOUTCOMMIT4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Oplayoutreturn() *LAYOUTRETURN4res {
	switch u.Resop {
	case OP_LAYOUTRETURN:
		if v, ok := u._u.(*LAYOUTRETURN4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opsecinfononame() *SECINFO_NO_NAME4res {
	switch u.Resop {
	case OP_SECINFO_NO_NAME:
		if v, ok := u._u.(*SECINFO_NO_NAME4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opteststateid() *TEST_STATEID4res {
	switch u.Resop {
	case OP_TEST_STATEID:
		if v, ok := u._u.(*TEST_STATEID4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opwantdelegation() *WANT_DELEGATION4res {
	switch u.Resop {
	case OP_WANT_DELEGATION:
		if v, ok := u._u.(*WANT_DELEGATION4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opdestroyclientid() *DESTROY_CLIENTID4res {
	switch u.Resop {
	case OP_DESTROY_CLIENTID:
		if v, ok := u._u.(*DESTROY_CLIENTID4res); ok {
			return v
		} else {
...
func (u *Nfs_resop4) Opreclaimcomplete() *RECLAIM_COMPLETE4res {
	switch u.Resop {
	case OP_RECLAIM_COMPLETE:
		if v, ok := u._u.(*RECLAIM_COMPLETE4res); ok {
			return v
		} else {
...
func (u *CB_GETATTR4res) Resok4() *CB_GETATTR4resok {
	switch u.Status {
	case NFS4_OK:
		if v, ok := u._u.(*CB_GETATTR4resok); ok {
			return v
		} else {
...
func (u *Nfs_cb_argop4) Opcbgetattr() *CB_GETATTR4args {
	...
	case OP_CB_GETATTR:
		if v, ok := u._u.(*CB_GETATTR4args); ok {
			return v
		} else {
...
func (u *Nfs_cb_argop4) Opcbrecall() *CB_RECALL4args {
	switch Nfs_cb_opnum4(u.Argop) {
	case OP_CB_RECALL:
		if v, ok := u._u.(*CB_RECALL4args); ok {
			return v
		} else {
...
func (u *Nfs_cb_resop4) Opcbgetattr() *CB_GETATTR4res {
	...
	case OP_CB_GETATTR:
		if v, ok := u._u.(*CB_GETATTR4res); ok {
			return v
		} else {
...
func (u *Nfs_cb_resop4) Opcbillegal() *CB_ILLEGAL4res {
	switch Nfs_cb_opnum4(u.Resop) {
	case OP_CB_ILLEGAL:
		if v, ok := u._u.(*CB_ILLEGAL4res); ok {
			return v
		} else {
